...
class CategorizationService:
    ...
    def _detect_category(self, file_path: Path) -> str:
        ...
        # Prioritize registry files based on specific naming conventions first.
        # This is more reliable than content sniffing for these file types.
        if file_name_lower.endswith('.reg') or file_name_lower.endswith('reg.txt'):
            return 'registry_files'

        # If not a clear registry file, then perform content-based detection for other types.
